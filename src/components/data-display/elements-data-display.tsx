  ...
  return (
    ...
    >
      <form className="flex flex-col p-10 gap-5" autoComplete="off">
        <h1 className="text-xl font-medium">Añadir elemento</h1>
        <input
          type="text"
          placeholder="Nombre"
...
function DataRow({ action }: DataRow) {
  return (
    <tr className="bg-white border-b dark:bg-gray-900 dark:border-gray-700 last:border-b-0">
      ...
      <td className="px-6 py-4">No sé</td>
      <td className="px-6 py-4">En ticket</td>
      ...
      <div className="absolute w-full px-8 py-5">
        <nav className="flex justify-between items-center">
          <div className="font-medium">
            Menu <Right className="w-3 h-3 inline" /> Elementos
          </div>
          <div>
            {isDropup && (
              <Dropup

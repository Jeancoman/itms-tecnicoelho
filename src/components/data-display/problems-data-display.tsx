  ...
  return (
    ...
    >
      <form className="flex flex-col p-10 gap-5" autoComplete="off">
        <h1 className="text-xl font-medium">Registrar problema</h1>
        <textarea
          rows={3}
...
function DataRow({ action }: DataRow) {
  return (
    <tr className="bg-white border border-slate-300 dark:bg-gray-900 dark:border-gray-700">
      ...
      <td className="px-6 py-4">323434354</td>
      <td className="px-6 py-2">
        <div className="bg-red-200 text-center text-red-600 text-xs py-2 font-bold rounded-full">
          Alta
        </div>
      </td>
      ...
      <div className="absolute w-full h-full px-8 py-5">
        <nav className="flex justify-between items-center">
          <div className="font-medium">
            Menu <Right className="w-3 h-3 inline" /> Problemas
          </div>
          <div>
            {isDropup && (
              <Dropup
